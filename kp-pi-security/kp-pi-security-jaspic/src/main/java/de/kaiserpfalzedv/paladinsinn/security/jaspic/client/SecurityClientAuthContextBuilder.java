...
public class SecurityClientAuthContextBuilder implements Builder<SecurityClientAuthContext> {
    ...
    @Override
    public SecurityClientAuthContext build() throws BuilderValidationException {
        ...
        return new SecurityClientAuthContext();
    }
    ...
    public SecurityClientAuthContextBuilder withProperties(final Map properties) {
