...
package de.kaiserpfalzedv.paladinsinn.security.ejb;
...
@Alternative
@WorkerService
public class JPAUserIdGenerator implements UserIdGenerator {

    @Override
    public String generateUserId(final Persona person, final Email emailAddress) {
        String result = generateBaseName(person, emailAddress);

        result = avoidDuplicates(result);

        return result;
    }

    private String generateBaseName(final Persona person, final Email emailAddress) {
        String result = null;
    ...
    private String avoidDuplicates(String result) {
        // TODO 2017-03-26 klenkes: create avoidance of duplicate algorithm
