 ...
 * @since 2017-03-11
 */
public class PrincipalBuilder extends IdentifiableAbstractBuilder<Principal> {
     ...
     */
    public PrincipalBuilder withUserIdGenerator(final UserIdGenerator userIdGenerator) {
        this.userIdGenerator = userIdGenerator;
        return this;
    }


    public PrincipalBuilder withPrincipal(final Principal principal) {
        withUniqueId(principal.getUniqueId());
        withName(principal.getName());
        withPerson(principal.getPerson());
        withEmailAddress(principal.getEmailAddress());

        return this;
    }


    public PrincipalBuilder withUniqueId(final UUID uniqueId) {
        return (PrincipalBuilder) super.withUniqueId(uniqueId);
    }

    public PrincipalBuilder withName(final String name) {
        return (PrincipalBuilder) super.withName(name);
    }

    public PrincipalBuilder withPerson(final Person person) {
        this.person = person ;
        return this;
    }
