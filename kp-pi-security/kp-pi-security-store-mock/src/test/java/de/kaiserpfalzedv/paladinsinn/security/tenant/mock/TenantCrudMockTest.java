...
import de.kaiserpfalzedv.paladinsinn.security.tenant.store.TenantCrudService;
import de.kaiserpfalzedv.paladinsinn.security.tenant.store.TenantPersistenceException;
import de.kaiserpfalzedv.paladinsinn.security.tenant.store.mock.TenantCrudMock;
...
public class TenantCrudMockTest {
    ...
    @Test
    public void shouldSaveTenantWhenCalledWithValidTenant() throws TenantPersistenceException {
    ...
    @Test
    public void shouldSaveAnotherTenantWhenCalledWithANotEqualTenant() throws TenantPersistenceException {
    ...
    @Test(expected = TenantPersistenceException.class)
    public void shouldFailWhenSavingATenantWithExistingUniqueId()
            throws TenantPersistenceException, BuilderValidationException {
        service.create(TENANT_1);
    ...
    @Test
    public void shouldRetrieveTenantWhenGivenAValidUniqueId() throws TenantPersistenceException {
    ...
    @Test
    public void shouldRetrieveTenantWhenGivenAValidKey() throws TenantPersistenceException {
        service.create(TENANT_3);
    ...
    private void generate6Tenants() {
        ...
        } catch (TenantPersistenceException e) {
    ...
    @Test
    public void shouldUpdateDataWhenGivenWithChangedName() throws BuilderValidationException, TenantPersistenceException {
        service.create(TENANT_1);
    ...
    @Test
    public void shouldReturnNoTenantWhenTenantIsDeletedBefore() throws TenantPersistenceException {
        service.create(TENANT_1);
    ...
    @Test
    public void shouldReturnNoTenantWhenTenantIsDeletedByUniqueIdBefore() throws TenantPersistenceException {
        service.create(TENANT_1);
    ...
    @Test
    public void shouldReturnNoTenantWhenTenantIsDeletedByNameBefore() throws TenantPersistenceException {
        service.create(TENANT_1);
